...
namespace Creativestyle\ProductVariantsExtension\Block\Product;
...
class VariantSwitcher extends \Magento\Framework\View\Element\Template
{
    ...
    /**
     * @var \Creativestyle\ProductVariantsExtension\Services\Utils\StringUtils
     */
    private $stringUtils;
    ...
    public function __construct(
        ...
        \Creativestyle\ProductVariantsExtension\Services\Utils\StringUtils $stringUtils,
        array $data = []
    )
    {
